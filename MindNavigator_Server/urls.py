...
if Intervention.objects.all().count() == 0:
    ...
    Intervention.objects.create_intervention(name="부모님 기쁘게 하기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name="골동품 복원 또는 가구 재정비하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name="컴퓨터 게임하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name="파트너와 성관계 갖기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name="쇼핑하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name="행복한 사람들과 함께하기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name="파티하기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name="편지, 카드 또는 메모 작성하기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name="정치 또는 공무에 대해 말하기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name="도움이나 조언 요청하기", intervention_type=InterventionManager.SYSTEM)
