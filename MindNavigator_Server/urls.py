...
if Intervention.objects.all().count() == 0:
    ...
    Intervention.objects.create_intervention(name=u"새소리, 바람, 파도 등 자연의 소리 듣기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"종교 단체, 자선 단체 또는 기타 단체에 기부하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"예술 작품 만들기 (그림, 색칠, 조각, 영화 만들기 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"경주 (말, 자동차, 보트 등) 보러가기 ", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"배타기 (카누 타기, 카약 타기, 모터보트 타기, 요트 타기 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"기계 작업 (자동차, 자전거, 오토바이, 트랙터 등)", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"미래에 일어날 좋은 일에 대해 생각하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"문제 해결 (퍼즐, 크로스워드 퀴즈 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"탐험 (알려진 도로에서 멀어지기, 등산 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"나 자신 또는 자신의 문제에 대해 생각해보기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"봉사, 시민 또는 사교클럽 모임에 가기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"공예품 만들기 (도자기, 보석, 가죽, 구슬, 직조 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"내 가족이나 친구들에게 좋은 일이 일어나길 기대하기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"박람회, 축제, 서커스, 동물원, 유원지 등 가기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"학교 또는 정부 회의, 법원 회의 등에 참석하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"외출하기 (공원, 피크닉, 바베큐 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"자연물 수집 (야생 식품 또는 과일, 암석, 유목지 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"주요 구매 또는 투자 (자동차, 가전 제품, 주택, 주식 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"직장에서 발전하기 (승진, 인상, 더 나은 직업 제공, 더 나은 학교 입학 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"건강 개선 (치아 고정, 새 안경 복용, 식사 변경 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"논문, 수필, 기사, 보고서, 메모 등 쓰기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"헬스 클럽, 사우나, 목욕탕 등에 가기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"맥도날드, 버거킹, 스타벅스 등 'drive through' 가기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"사회, 정치 또는 환경 적 조건에 대한 항의", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"잔디 스포츠 (예 : 배드민턴, 크로켓, 셔플 보드, 말굽 등)", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"직장 또는 학급에있는 사람들과 이야기하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"보드 게임하기 (모노 폴리, 스크래블 등)", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"밤에 푹 자기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"힘든 실외 작업 (목재 절단, 도마, 토지 개간, 농장 작업 등)", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"신문 읽기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"사람들을 놀라게하고, 욕설을 퍼붓고, 외설스러운 몸짓하기 등", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"눈에서 스노우모빌 타기", intervention_type=InterventionManager.SYSTEM)
    Intervention.objects.create_intervention(name=u"신체 인식, 감수성, 만남, 치료 받기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"조깅, 달리기, 체조, 피트니스 또는 현장 연습하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"뜨개질, 크로 셰 뜨개질, 자수 또는 고급 바느질 작업", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"축구, 럭비, 하키, 라크로스 등을 즐기기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"취미 또는 특별한 관심사에 대해 이야기하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"친구와 함께 커피, 차, 콜라 등 마시기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"떠난 친구 또는 사랑하는 사람 기억하기, 공동 묘지 방문하기", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"자원 봉사 활동, 지역 사회 봉사 프로젝트 작업", intervention_type=InterventionManager.SYSTEM)
    ...
    Intervention.objects.create_intervention(name=u"누군가를 방어하거나 보호하기, 사기 또는 남용 중지", intervention_type=InterventionManager.SYSTEM)
